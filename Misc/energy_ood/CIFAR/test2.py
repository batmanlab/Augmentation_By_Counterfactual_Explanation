...
parser.add_argument('--chkpt_path', default='/jet/home/nmurali/asc170022p/nmurali/projects/augmentation_by_explanation_eccv22/Misc/energy_ood/CIFAR/snapshots/oe_tune/mnist/mnist_densenet_s1_oe_tune_epoch_450.pt', type=str)
parser.add_argument('--ood_type', default='nood', type=str, help='aid|food1|food2')
# Setup
