...
def ODIN(inputs, outputs, model, temper, noiseMagnitude1):
    ...
    try:
        ...
        try:
            ...
            raise('Issue with gradient vector')
...
def get_Mahalanobis_score(model, test_loader, num_classes, in_channels, sample_mean, precision, layer_index, magnitude, num_batches, in_dist=False):
    '''
    ...
    for batch_idx, samples in enumerate(tqdm(test_loader)):
        if batch_idx>500:
            break
    ...
    for samples in tqdm(train_loader):
        try:
            ...
            try:
                ...
                raise('Problem iterating train_loader')
